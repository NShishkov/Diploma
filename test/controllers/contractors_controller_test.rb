...
class ContractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contractor" do
    assert_difference('Contractor.count') do
      post contractors_url, params: { contractor: { address: @contractor.address, info: @contractor.info, name: @contractor.name, patronymic: @contractor.patronymic, phone_number: @contractor.phone_number, rating: @contractor.rating, surname: @contractor.surname } }
    end
  ...
  test "should update contractor" do
    patch contractor_url(@contractor), params: { contractor: { address: @contractor.address, info: @contractor.info, name: @contractor.name, patronymic: @contractor.patronymic, phone_number: @contractor.phone_number, rating: @contractor.rating, surname: @contractor.surname } }
